...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        html, body { font-family: 'Inter', sans-serif; background: var(--page-bg); color: var(--text-main); height: 100%; }
        ...
        <div class="transactions-wrapper">
            ...
            <div style="overflow-x: auto;">
                <table class="tx-table" id="txTable">
                    <thead>
                        <tr>
                            <th>Date</th><th>Treasurer</th><th>Type</th><th>Description</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><span class="badge {{ $tx->type == 'funds' ? 'badge-income' : 'badge-expense' }}">{{ ucfirst($tx->type) }}</span></td>
...
<script>
    ...
    document.getElementById('exportPdfBtn').addEventListener('click', function () {
        ...
        doc.autoTable({
            ...
            theme: 'striped', headStyles: { fillColor: [15, 42, 42] }, styles: { fontSize: 8 },
            didDrawPage: (data) => {
                if (data.pageNumber > 1) drawHeader();
                doc.setFontSize(7); doc.text('Page ' + data.pageNumber, W - 15, H - 5);
            }
        });
